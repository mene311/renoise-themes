...
const insertTheme = db.prepare(`
  INSERT INTO themes (
    name, filename, original_name, author, description, screenshots, palette_svg,
    ...
    @name, @filename, @originalName, @author, @description, @screenshots, @paletteSVG,
...
export function saveTheme({ name, filename, originalName, author, description, screenshots, paletteSVG, previewSlug, previewViews, stats, tags, topColors }) {
  const result = insertTheme.run({
    name, filename, originalName, author,
